...
function ModalEditar({
    ...
    const aoSalvar = async () => {
        ...
        if (dominioProibidoEncontrado) {
            setVideoError('No se permite la inclusión de videos con contenido para adultos.');
            return;
        } else {
            setVideoError('');
        }
        ...
        try {
            ...
            mostrarNotificacao("¡Tarjeta actualizada con éxito!", "success");
            fechado();
        } catch (error) {
            console.error("Error al actualizar la tarjeta:", error);
            mostrarNotificacao("Error al actualizar la tarjeta", "error");
        }
    };
        ...
        <>
            ...
            <DialogEstilizado aberto={aberto}>
                ...
                <Form>
                    ...
                    <BoxBotoes>
                        <Botao type="button" onClick={aoSalvar}>GUARDAR</Botao>
